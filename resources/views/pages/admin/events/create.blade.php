...
<div class="container mx-auto px-4 py-6 max-w-4xl">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="bg-gray-50 border-b border-gray-100 p-6">
            <h2 class="text-xl font-bold text-gray-800">Form Pembuatan Event Baru</h2>
        </div>
        ...
        <form action="{{ route('admin.events.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-2">
                    ...
                    <input type="text" name="judul" value="{{ old('judul') }}" required class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 @error('judul') border-red-500 @enderror">
                ...
                <div class="space-y-2">
                    ...
                    <select name="kategori_id" required class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 @error('kategori_id') border-red-500 @enderror">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="lokasi" value="{{ old('lokasi') }}" required class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 @error('lokasi') border-red-500 @enderror">
                ...
                <div class="space-y-2">
                    ...
                    <input type="datetime-local" name="tanggal_waktu" value="{{ old('tanggal_waktu') }}" required class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 @error('tanggal_waktu') border-red-500 @enderror">
                ...
                <div class="space-y-2 md:col-span-2">
                    <label class="block">
                        ...
                        <span class="text-gray-400 text-xs">(Max 2MB)</span>
                    </label>
                ...
                <div class="space-y-2 md:col-span-2">
                    ...
                    <textarea name="deskripsi" rows="5" required class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 @error('deskripsi') border-red-500 @enderror">{{ old('deskripsi') }}</textarea>
            ...
            <div class="space-y-6">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-xs text-gray-500">Tambahkan opsi tipe tiket untuk event ini.</p>
                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
            ...
            card.innerHTML = `
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="number" name="tikets[${index}][harga]" min="0" required placeholder="Contoh: 150000" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-xs focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="number" name="tikets[${index}][kuota]" min="1" required placeholder="Stok tiket" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-xs focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                </div>
            `;
            return card;
        ...
        btnAddTicket.addEventListener('click', function () {
            ticketsContainer.appendChild(createTicketCard(ticketIndex));
            ticketIndex++;
        });
        ...
        ticketsContainer.addEventListener('click', function (e) {
            if (e.target.classList.contains('btn-remove-ticket')) {
                ...
                // Urutkan kembali penomoran visual
